...
const card = tv({
  slots: {
    ...
    description: "text-base dl2 text-muted-fg sm:text-lg",
    content:
      "yahnba px-6 pb-6 text-2xl has-[.t-hea]:bg-secondary/40 has-[table]:p-0 [&:has(table)+.ccvgs8x]:py-5 [&:has(table)]:border-t [&_.t-cel]:px-6 [&_.t-col]:px-6",
